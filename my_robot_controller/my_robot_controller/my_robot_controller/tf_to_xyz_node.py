...
class TFtoXYZNode(Node):
    ...
    def listener_callback_tf(self, msg):
        ...
        for transform in msg.transforms:
            ...
            marker_msg = Marker()
            marker_msg.header.frame_id = transform.header.frame_id
    ...
    def publish_transform(self, transform):
        ...
        t.header.frame_id = transform.header.frame_id  # Il frame di riferimento genitore
        ...
        t.transform.translation.z = self.current_position.z  # Posiziona sotto il piano della telecamera
